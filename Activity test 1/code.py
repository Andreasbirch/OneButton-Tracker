...
board_control = switch.value
print("Control of board is given to {}".format("board" if board_control else "computer"))

if board_control:
    with open("/ims.txt", "a") as fp:
        start_time = time.monotonic_ns()
        fp.write("timestamp, accel_x, accel_y, accel_z, gyro_x, gyro_y, gyro_z, mag_x, mag_y, mag_z, quat_i, quat_j, quat_k, quat_real\n")
        while True:
            time.sleep(0.5)
