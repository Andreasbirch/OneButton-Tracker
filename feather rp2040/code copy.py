...
from adafruit_bno08x.i2c import BNO08X_I2C, BNO_REPORT_ACCELEROMETER, BNO_REPORT_STABILITY_CLASSIFIER
import busio
import math
...
logger = boardLogger.BoardLogger(headers=['timestamp', 'acc_magnitude', 'stability', 'tilt_x', 'tilt_y'])
...
if alarm.sleep_memory[0]:
    if alarm.sleep_memory[0] != timestamp.tm_hour:
        ...
        data.append([timestamp_unix, logger.get_voltage(board.A0)])
