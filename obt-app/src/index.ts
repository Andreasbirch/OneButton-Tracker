...
ipcMain.handle('get-device-mapping', async () => {
...
const broadcastDevices = (data: string) => {
...
const handleDeviceConnect = async () => {
    let circuitpyDrives = ["asd", "123"]//await getCircuitpyDrives();
    let data = circuitpyDrives ? circuitpyDrives.join('\n') : "No devices found";
    broadcastDevices(data);
};

webusb.addEventListener('connect', handleDeviceConnect);
webusb.addEventListener('disconnect', handleDeviceConnect);
